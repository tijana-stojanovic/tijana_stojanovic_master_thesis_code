#CAD
protein1 <- c("CD34", "EPHA4", "HJV","PLA2G7","PODXL","SUSD2")
...
strok <- rio::import("/Users/tikas/Documents/Master's programme/Degree project/Results/MR VTE, stroke and CAD results/mr_results_cad_proteins.xlsx")
