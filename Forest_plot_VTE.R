#VTE
protein1 <- c("ANGPTL3", "FOLR1", "L1CAM","PDGFRA")
...
# line 113 - Warning message: The `size` argument of `element_rect()` is deprecated as of ggplot2 3.4.0.; ℹ Please use the `linewidth` argument instead.
# Create forest plot
...
strok <- rio::import("/Users/tikas/Documents/Master's programme/Degree project/Results/MR VTE, stroke and CAD results/mr_results_vte_proteins.xlsx")
